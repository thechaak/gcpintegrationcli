...
if [ "${INTEGRATIONCLI_VERSION}" = "" ] ; then
  INTEGRATIONCLI_VERSION="$(curl -sL https://github.com/thechaak/gcpintegrationcli/releases/latest | \
...
cd "$tmp" || exit
URL="https://github.com/thechaak/gcpintegrationcli/releases/download/${INTEGRATIONCLI_VERSION}/integrationcli_${INTEGRATIONCLI_VERSION}_${OSEXT}_${INTEGRATIONCLI_ARCH}.zip"
